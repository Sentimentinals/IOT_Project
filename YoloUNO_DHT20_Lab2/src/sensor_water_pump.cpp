...
static const unsigned long MANUAL_TIMEOUT_MS = 300000;

// FreeRTOS task: Control water pump based on soil moisture or manual command
...
// Set water pump to manual mode (called from WebSocket handler)
